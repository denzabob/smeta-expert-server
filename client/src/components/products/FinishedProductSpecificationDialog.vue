    ...
    <v-card>
      <v-card-title class="d-flex align-center">
        <div>
          ...
          <div class="text-body-2 text-medium-emphasis">
            Каноническая спецификация готового изделия на новом spec-rooted backend.
          </div>
        </div>
        <v-spacer />
      ...
      <v-card-text class="pt-2">
        ...
        <v-alert type="info" variant="tonal" density="compact" class="mt-4">
          Управление источниками цен и evidence будет подключено следующим блоком. Здесь мы создаем и редактируем только саму спецификацию.
        </v-alert>
      </v-card-text>
