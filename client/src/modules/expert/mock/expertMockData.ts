...
const commodityProject: ExpertProject = {
  ...
  findings: [
    {
      id: 'finding-1', number: 1, title: 'Неравномерность межфасадных зазоров', type: 'defect', typeLabel: 'Недостаток', object: 'Фасад антресольного шкафа',
      ...
      sources: [{ id: 's-2', label: 'Акт осмотра', detail: 'стр. 4' }, { id: 's-3', label: 'Фото №32–38' }], status: 'Подтверждено экспертом', images: ['Фото №32', 'Фото №35'],
    },
    {
      id: 'finding-2', number: 2, title: 'Расхождение комплектации', type: 'non_compliance', typeLabel: 'Несоответствие', object: 'Комплект поставки',
      ...
      sources: [{ id: 's-1', label: 'Договор №144', detail: 'приложение 1' }], status: 'Предложено AI',
    },
  ],
  normatives: [
    { id: 'n-1', code: 'ГОСТ 16371-2014', title: 'Мебель. Общие технические условия', applicability: 'Требования к качеству изготовления и внешнему виду мебели.', connected: true },
    { id: 'n-2', code: 'ТР ТС 025/2012', title: 'О безопасности мебельной продукции', applicability: 'Общие требования безопасности мебельной продукции.', connected: true },
    { id: 'n-3', code: 'ГОСТ 20400-2013', title: 'Продукция мебельного производства. Термины и определения', applicability: 'Терминология для описания объекта и выявленных обстоятельств.', connected: false, recommended: true },
  ],
  reportSections: [
    { id: 'r-1', number: 1, title: 'Вводная часть', content: 'Настоящее заключение подготовлено по результатам исследования представленных материалов и осмотра объекта.' },
    { id: 'r-2', number: 2, title: 'Материалы исследования', content: 'Для исследования представлены договор, спецификация, акт осмотра, результаты измерений и фотоматериалы.' },
    { id: 'r-3', number: 3, title: 'Исследовательская часть', content: 'В ходе исследования выполнено сопоставление фактических характеристик объекта с исходными документами.' },
    { id: 'r-4', number: 4, title: 'Выводы', content: 'Формулировки ответов на поставленные вопросы находятся в работе.' },
  ],
  revisions: [
    { id: 'v3', label: 'v3', createdAt: 'Сегодня, 21:35', current: true },
    { id: 'v2', label: 'v2', createdAt: 'Сегодня, 20:12' },
    { id: 'v1', label: 'v1', createdAt: 'Сегодня, 18:44' },
  ],
}
...
const constructionProject: ExpertProject = {
  ...
  findings: [
    {
      id: 'c-finding-1', number: 1, title: 'Отклонение поверхности перекрытия', type: 'non_compliance', typeLabel: 'Несоответствие', object: 'Монолитное перекрытие',
      ...
      sources: [{ id: 'c-s-1', label: 'Акт обследования', detail: 'стр. 6' }, { id: 'c-s-2', label: 'Результаты измерений', detail: 'лист 2' }], status: 'Подтверждено экспертом', images: ['Фото №12', 'Фото №14'],
    },
    {
      id: 'c-finding-2', number: 2, title: 'Локальные следы увлажнения', type: 'observation', typeLabel: 'Наблюдение', object: 'Участок примыкания перекрытия',
      description: 'При визуальном обследовании зафиксированы локальные следы увлажнения.',
      sources: [{ id: 'c-s-3', label: 'Фото конструкций', detail: 'Фото №21–24' }], status: 'Предложено AI',
    },
  ],
  normatives: [
    { id: 'c-n-1', code: 'СП 13-102-2003', title: 'Правила обследования несущих строительных конструкций', applicability: 'Методика обследования и фиксации технического состояния.', connected: true },
    { id: 'c-n-2', code: 'СП 70.13330.2012', title: 'Несущие и ограждающие конструкции', applicability: 'Сопоставление качества выполненных бетонных работ.', connected: true },
    { id: 'c-n-3', code: 'ГОСТ 31937-2024', title: 'Здания и сооружения. Правила обследования', applicability: 'Возможная применимость к оценке технического состояния.', connected: false, recommended: true },
  ],
  reportSections: [
    { id: 'c-r-1', number: 1, title: 'Вводная часть', content: 'Исследование выполнено в отношении конструкций жилого дома на основании представленных исходных данных.' },
    { id: 'c-r-2', number: 2, title: 'Материалы исследования', content: 'Исследованы проектная документация, акт обследования, результаты измерений и фотоматериалы.' },
    { id: 'c-r-3', number: 3, title: 'Исследовательская часть', content: 'Выполнены визуальный анализ, сопоставление с проектной документацией и оценка результатов измерений.' },
    { id: 'c-r-4', number: 4, title: 'Выводы', content: 'Ответы на вопросы будут сформулированы после проверки расчётной части.' },
  ],
  revisions: [
    { id: 'v2', label: 'v2', createdAt: 'Сегодня, 19:10', current: true },
    { id: 'v1', label: 'v1', createdAt: 'Сегодня, 16:42' },
  ],
}
