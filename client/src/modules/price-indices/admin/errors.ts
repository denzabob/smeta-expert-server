...
const messages: Record<string, string> = {
  ...
  preview_not_found: 'Предварительный анализ не найден.',
  preview_source_file_mismatch: 'Результат анализа относится к другому исходному файлу. Запустите анализ выбранного файла повторно.',
  preview_importer_mismatch: 'Результат анализа создан другой версией импортера. Запустите анализ повторно.',
