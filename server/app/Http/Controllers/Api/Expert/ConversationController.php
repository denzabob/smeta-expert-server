...
use App\Http\Controllers\Controller; use App\Http\Requests\Expert\ConversationRequest; use App\Http\Resources\Expert\ConversationResource; use App\Models\Expert\ExpertConversation; use App\Models\Expert\ExpertProject;
class ConversationController extends Controller
{
    public function index(ExpertProject $project){$this->authorize('view',$project);return ConversationResource::collection($project->conversations()->withCount('messages')->get());}
